...
import {EnableDragContext, MobileContext, ImageContext, OutputSizeContext, ImageNameContext, ReverseContext, NoiseAmountContext, NoiseSizeContext, patterns} from "../Context"
...
const NoiseImage: React.FunctionComponent = (props) => {
    ...
    }, [img, noiseAmount, noiseSize, gifData, seed])
